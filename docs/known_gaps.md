...
**Upstream (already on disk, transcription pending):**
  ...
  - `Vrancik1968_NASA_TN_D4849` — primary windage formula (read-through complete 2026-05-22; windage cite upgraded C → A confidence).
...
**Upstream:** `Wright2010_SAND2010_0171` (transcribed); `Wright2011_SAND2010_8840` (Table 2-1 + Table 4-1 transcribed 2026-05-22); `Held2025_BYU_pilot` (transcribed: Table 2 state points; Table 1 / Table 3 design points indexed in extract doc but not yet rowed). All three entries indexed in `docs/data_extracts/_acquisition_log.md`. (`Conboy2014_SAND2014_2098` retired 2026-05-22 due to source-identity error — see Gap 1.)
