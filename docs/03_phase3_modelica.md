...
|---|---|---|---|
| `Compressor.mo` (current scalar performance defaults) | engineering-typical values, not source-anchored | n/a | `eta_isen_design = 0.85`, `mdot_design = 100 kg/s`, `PR_design = 2.5` — placeholder; off-design map remains a future deliverable |
